...
Порог ужесточён 02.07.2026 (решение оператора): 0.10 -> 0.25 после того,
как кит с ROI 19%/мес (palegrit) попал в копи-алерты. Прежнее «держим все ~20
ради диверсификации» отменено: копируем только верхний эшелон (~6 китов) —
для невалидированной стратегии качество сигнала важнее ширины выборки.
"""
...
MIN_EFF = 0.25          # pnl/vol ≥ 25%/мес — только верхний эшелон (было 0.10)
